...
router.get('/', function (req, res) {
  res.render('index', { title: 'entertainment App', user: req.user });
});

router.get('/register', function (req, res) {
  res.render('register', { title: 'entertainment App Registration' });
});
...
router.get('/login', function (req, res) {
  res.render('login', { title: 'entertainment App Login', user: req.user });
});
